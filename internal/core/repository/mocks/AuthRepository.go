...
import (
	...
	response "go-question-board/internal/core/entity/response"
)
...
func (_m *AuthRepository) Login(_a0 string) (response.UserDetails, error) {
	ret := _m.Called(_a0)

	var r0 response.UserDetails
	if rf, ok := ret.Get(0).(func(string) response.UserDetails); ok {
		r0 = rf(_a0)
	} else {
		r0 = ret.Get(0).(response.UserDetails)
	}
